...
new TypeIt("#teks1", {
  strings: ["Selamat hari valentine Lien..."," ","Mungkin kita memang belum punya status apa apa. Tapi hari ini rasanya sayang kalau aku terus diam. Sejak kamu hadir, banyak hal terasa lebih hangat."," ","Obrolan kecil kita sering jadi bagian terbaik dari hariku. Tanpa kamu sadari, kamu sudah jadi seseorang yang berarti buatku."," ","Aku tidak ingin terburu buru. Aku hanya ingin kamu tahu, rasaku tumbuh dengan tulus."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Aku tidak menulis ini untuk menekan atau meminta jawaban cepat. Aku hanya ingin jujur tentang apa yang aku rasakan. Aku melihat kamu bukan sekadar teman biasa."," ","Kalau suatu hari kamu membuka hati untukku, itu akan jadi hal yang sangat aku jaga. Dan kalau kamu masih butuh waktu, aku tetap bersyukur karena pernah punya rasa seindah ini untuk kamu."," ","- Thank you for being part of my story."],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
...
new TypeIt("#trims", {
  strings: ["Terimakasih sudah bertahan."],
  startDelay: 1500,
  speed: 200,
  waitUntilVisible: true,
}).go();
